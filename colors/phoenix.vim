...
hi Normal                     guifg=#CCCCCC guibg=#090909 gui=NONE      ctermfg=250
...
if s:accent == "red"
  ...
  hi Type                     guifg=#FF3D23 guibg=NONE    gui=NONE      ctermfg=001
  hi SpecialKey               guifg=#FF3D23 guibg=NONE    gui=NONE      ctermfg=001
  hi Conditional              guifg=#FF3D23 guibg=NONE    gui=NONE      ctermfg=001
  hi Exception                guifg=#FF3D23 guibg=NONE    gui=NONE      ctermfg=001
  hi Label                    guifg=#FF3D23 guibg=NONE    gui=NONE      ctermfg=001
  hi Repeat                   guifg=#FF3D23 guibg=NONE    gui=NONE      ctermfg=001
  hi Keyword                  guifg=#FF3D23 guibg=NONE    gui=NONE      ctermfg=001
  hi String                   guifg=#FF3D23 guibg=NONE    gui=NONE      ctermfg=001
...
if s:accent == "green"
  ...
  hi Type                     guifg=#87BF19 guibg=NONE    gui=NONE      ctermfg=002
  hi SpecialKey               guifg=#87BF19 guibg=NONE    gui=NONE      ctermfg=002
  hi Conditional              guifg=#87BF19 guibg=NONE    gui=NONE      ctermfg=002
  hi Exception                guifg=#87BF19 guibg=NONE    gui=NONE      ctermfg=002
  hi Label                    guifg=#87BF19 guibg=NONE    gui=NONE      ctermfg=002
  hi Repeat                   guifg=#87BF19 guibg=NONE    gui=NONE      ctermfg=002
  hi Keyword                  guifg=#87BF19 guibg=NONE    gui=NONE      ctermfg=002
  hi String                   guifg=#87BF19 guibg=NONE    gui=NONE      ctermfg=002
...
if s:accent == "orange"
  hi Constant                 guifg=#FBBE1C guibg=NONE    gui=NONE      ctermfg=208
  hi Directory                guifg=#FBBE1C guibg=NONE    gui=NONE      ctermfg=208
  hi Type                     guifg=#FBBE1C guibg=NONE    gui=NONE      ctermfg=208
  hi SpecialKey               guifg=#FBBE1C guibg=NONE    gui=NONE      ctermfg=208
  ...
  hi String                   guifg=#FBBE1C guibg=NONE    gui=NONE      ctermfg=208
  hi Character                guifg=#FBBE1C guibg=NONE    gui=NONE      ctermfg=208
  hi Boolean                  guifg=#FBBE1C guibg=NONE    gui=NONE      ctermfg=208
  hi Number                   guifg=#FBBE1C guibg=NONE    gui=NONE      ctermfg=208
...
hi StatusLineNC               guifg=#CCCBCC guibg=NONE    gui=NONE      ctermfg=250   ctermbg=NONE
